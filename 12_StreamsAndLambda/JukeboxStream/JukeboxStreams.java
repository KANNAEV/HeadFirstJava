...
public class JukeboxStreams {
    public static void main(String[] args) {
        ...
        // Только группы Битлз
        List<Song> theBeatles = songs.stream()
        ...
        List<Song> after1995 = songs.stream()
                ...
                .sorted((song1, song2) -> song1.getYear() - song2.getYear())
                .toList();
...
class Songs {
    public List<Song> getSongs() {
        return List.of(
                ...
                new Song("Immigrant JukeboxStream.Song", "Karen O", "Industrial Rock", 2011, 12),
